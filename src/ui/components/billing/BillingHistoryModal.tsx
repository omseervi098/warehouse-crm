...
interface FilterOptions {
    startDate: string;
    endDate: string;
    transactionType: 'all' | 'bills' | 'payments';
}
...
const BillingHistoryModal: React.FC<BillingHistoryModalProps> = ({
    ...
    const applyFilters = useCallback(() => {
        ...
        filtered.sort((a, b) => {
            ...
            // If dates are equal, payments come before bills
    ...
    const handleDelete = useCallback(async (e: React.MouseEvent, item: BillingHistoryItem) => {
        ...
        try {
            ...
            notify({ type: 'success', message: `${item.type === 'bill' ? 'Bill' : 'Payment'} deleted successfully` });
            handleRefresh();
        } catch (error: any) {
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center space-x-3 mb-1">
                                                ...
                                                <div className="flex items-center space-x-1 border-l pl-2 border-gray-200 dark:border-gray-700">
                                                    ...
                                                    <button
                                                        ...
                                                        title={`Delete ${item.type === 'bill' ? 'Bill' : 'Payment'}`}
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div className="text-right">
                                            <div className={`text-lg font-semibold ${item.type === 'bill' ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'
                                                }`}>
